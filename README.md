...
* Use "data_github.csv" file, which will help you to automaticly select train_images, train_masks, test_images and test_masks. Please place it in your "Data" folder.
