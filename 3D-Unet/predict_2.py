...
def main():
    ...
    model_dir  = r"C:\Users\Utilisateur\OneDrive - ABYS MEDICAL\Bureau\projet\Segmentation\3D-Unet\model"
    ...
    with torch.no_grad():
        for test_data in test_loader:
            ...
            convert_nifti_to_dicom(os.path.join(args.output), r"D:\testforseg")  
